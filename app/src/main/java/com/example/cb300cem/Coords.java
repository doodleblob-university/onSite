...
public class Coords {
    ...
    public interface LocationCallback {
        void coordHandler(String lat, String lon);
    }
    ...
    public void getLocation(FusedLocationProviderClient fusedLocationProviderClient) {
        fusedLocationProviderClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<android.location.Location>() {
            ...
            public void onComplete(@NonNull @NotNull Task<android.location.Location> task) {
                ...
                locationCallback.coordHandler(lat, lon);
            }
        });
    }
